...
describe('csvParser', () => {
  ...
  describe('transformPeptideData', () => {
    ...
    it('should filter out excluded products (case-insensitive)', () => {
      const rawData = [
        { 'Product': 'PEP-A1-TEST', 'SKU': 'Test Product' },
        { 'Product': 'pep-a1-test', 'SKU': 'Test Product Lower' },
        { 'Product': 'PEP-GH-FRAGMENT-176-191-5MG', 'SKU': 'Fragment' },
        { 'Product': 'PT-001', 'SKU': 'Valid Product' }
      ];

      const excludedProducts = ['PEP-A1-TEST', 'PEP-GH-FRAGMENT-176-191-5MG'];
