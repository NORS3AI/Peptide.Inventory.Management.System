# Peptide Inventory System - Deployment Guide
...
# Start backend
cd backend
pm2 start src/server.js --name peptide-inventory-api
...
server {
    ...
    # Frontend
    location / {
        root /path/to/peptide.inventory.management.system/frontend/dist;
