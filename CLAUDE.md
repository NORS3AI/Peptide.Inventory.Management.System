# CLAUDE.md - Peptide Inventory System

## Project Overview
Peptide Inventory Management System — a client-side inventory management app for peptide manufacturing operations. Built with React 19 + Vite 7 + Tailwind CSS 3, deployed as a static site on GitHub Pages from the `docs/` folder.
...
- **Icons**: lucide-react
- **Repo**: `NORS3AI/peptide.inventory.management.system` (local path `/home/user/Peptide.Inventory.Management.System`)
...
```
Vite base path is set to `/peptide.inventory.management.system/` in vite.config.js.
